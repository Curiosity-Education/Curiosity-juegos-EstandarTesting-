...
var juego = new Phaser.Game(1024, 768, Phaser.CANVAS, 'bloque');
...
var estadoPrincipal = {
    ...
    preload: function(){
        ...
        juego.load.image('fondo', 'packages/images/games/fondo.png');
        juego.load.image('grid', 'packages/images/games/tablero.png');
        ...
        juego.load.image('paraguas', 'packages/images/games/paraguas.png');
        juego.load.image('reloj', 'packages/images/games/reloj.png');
        juego.load.image('estrella', 'packages/images/games/estrella.png');
        juego.load.spritesheet('btnFull', 'packages/images/games/fullScreen.png', 100, 100);

        //Esta zona es para declarar todos los botones usados para los parametros X y Y
        juego.load.spritesheet('boton_1', 'packages/images/games/boton1.png',200, 200);
        juego.load.spritesheet('boton_2', 'packages/images/games/boton2.png',200, 200);
        juego.load.spritesheet('boton_3', 'packages/images/games/boton3.png',200, 200);
        juego.load.spritesheet('boton_4', 'packages/images/games/boton4.png',200, 200);
        juego.load.spritesheet('boton_5', 'packages/images/games/boton5.png',200, 200);
        juego.load.spritesheet('boton_6', 'packages/images/games/boton6.png',200, 200);
        juego.load.spritesheet('boton_a', 'packages/images/games/botona.png',200, 200);
        juego.load.spritesheet('boton_b', 'packages/images/games/botonb.png',200, 200);
        juego.load.spritesheet('boton_c', 'packages/images/games/botonc.png',200, 200);
        juego.load.spritesheet('boton_d', 'packages/images/games/botond.png',200, 200);
        juego.load.spritesheet('boton_e', 'packages/images/games/botone.png',200, 200);
        juego.load.spritesheet('boton_f', 'packages/images/games/botonf.png',200, 200);

        //se  inicializan los 4 dulces a usar en el juego
        juego.load.image('dulce1', 'packages/images/games/dulce_rojo.png');
        juego.load.image('dulce2', 'packages/images/games/dulce_amarillo.png');
        juego.load.image('dulce3', 'packages/images/games/dulce_verde.png');
        juego.load.image('dulce4', 'packages/images/games/dulce_azul.png');


        juego.load.image('tarro2', 'packages/images/games/jar-yellow.png');
        juego.load.image('tarro3', 'packages/images/games/jar-green.png');
        juego.load.image('tarro4', 'packages/images/games/jar-blue.png');
        juego.load.image('tarro1', 'packages/images/games/jar-pink.png');
